...
# Percorso permanente per il file JSON
file_path = 'terms_data.json'
...
@app.route('/get_term/<variable_name>/<term_name>', methods=['GET'])
...
@app.route('/delete_term/<term_name>', methods=['POST'])
...
@app.route('/modify_term/<term_name>', methods=['PUT'])
